...
public final class Authorization {
    ...
    public static boolean loadSession()
    {
        ...
        reader.close();
        if(token == generateSessionToken(phone, UserUtilities.getDeviceID()))
        {
            loadUser(phone);
            return true;
        }
    ...
    private static void loadUser(String phone)
    {
        try {
            ...
            ClientSocket.send(MessageWrapperFactory.createUpdateMissedMessageWrapper(new UpdateMissedMessagesHolder("380507128080")));
