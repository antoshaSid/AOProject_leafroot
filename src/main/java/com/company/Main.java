...
//        ChatUtilities.getAllChatPhones();
        ...
        while (true)
        {
            var m = new SendMessageHolder(login,"380507128083",new Message(MessageType.Text,new Scanner(System.in).nextLine(),Generator.getRandomMessageID()));
